...
class SrchResults extends Component {
  ...
  resizeHandler = () => {
    if (this.containerWidthRef.current) {
      ...
      const elWidth = w < 631 ? (this.containerWidthRef.current.clientWidth * .44 + 20) : w < 769 ? 170 : w < 1221 ? 220 : w  < 1421 ? 270 : 320;
  ...
  searchHandler = (event) => {
    axios.get('https://cors-anywhere.herokuapp.com/https://api.deezer.com/search/artist',
    {params: {
  ...
  render() {
      ...
      if (this.state.searchResults) {
        console.log(this.state.flexAdd)
