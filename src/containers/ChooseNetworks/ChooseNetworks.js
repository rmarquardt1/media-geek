...
class ChooseNetworks extends Component {
  ...
  onSubmitHandler = () => {
    ...
    axios.put('https://mediageek-650c6.firebaseio.com/users/' + uid + '/favNetworks.json', networks).then(response => {
...
render() {
  ...
  const networks = [
    ...
    //   name: 'YouTube',
    //   id: 247,
    //   image: 'http://image.tmdb.org/t/p/w154/9Ga8A5QegQmiSVHp4hyusfMfpVk.png'
    // },
    {
      name: 'HBO',
      id: 49,
