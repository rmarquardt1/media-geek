...
render() {
  ...
  return (
    ...
    <div style={{flexGrow: 1, margin:'auto'}}><FontAwesomeIcon onClick={this.props.clickPlay.bind(this, {...this.state})} className={classes.PlayIcon} icon={faPlayCircle} /></div>
...
//     <span className={classes.AlbumName}>{props.album}</span>
    
//   </div>
//   <div style={{flexGrow: 1, margin:'auto'}}><FontAwesomeIcon onClick={props.clickPlay} className={classes.PlayIcon} icon={faPlayCircle} /></div>
